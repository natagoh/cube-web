...
var cubeSetup = function() {
  ...
  document.getElementById("scene").style.WebkitPerspectiveOrigin = "50% " + h/2 + "px"; // Chrome, Safari and Opera
  document.getElementById("scene").style.perspectiveOrigin = "50% " + h/2 + "px";
